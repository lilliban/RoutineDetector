...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ("enrichment".equalsIgnoreCase(cfg.mode)) {
            ...
            for (Map.Entry<String, String> entry : strategies.entrySet()) {
                ...
                String strategyCode = entry.getValue();

                System.out.println("  - Detecting: " + community + " (strategy " + strategyCode + ")");
                ...
                writeDetectedRoutinesSeparate(detected, cfg.outputDir, community);
            }
        }
    ...
    static class Args {
        ...
        Args(String eventsPath, String communitiesPath, String outputDir, String mode) {
        ...
        static Args parse(String[] args) {
            String events = null, comm = null, out = null, mode = "detection";
            ...
            return new Args(events, comm, out, mode);
        }
    }
}